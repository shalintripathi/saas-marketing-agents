...
| 🌍 | **Local & International SEO Specialist** | [`seo/seo-local-and-international.md`](seo/seo-local-and-international.md) | Multi-market growth strategist for global expansion — hreflang sets and x-default, locale URL architecture (ccTLD vs. subfolder), the auto-redirect trap that hides localized pages from Googlebot, machine-translation review policy, content-parity drift, and regional keyword strategy |
