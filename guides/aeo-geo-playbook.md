...
> _Last reviewed: 2026-09-21. This is a living document — AI search changes fast, and this repo commits to keeping it current. Effect sizes below come from named studies; treat them as directional, not guarantees. Contested points are flagged._
...
> **Engine divergence, flagged (Aug 2026).** Treat that "6× G2" as a pre-August-2026 measurement that blended engines — Reddit is no longer a single reliable AI channel. In mid-August 2026 two independent GEO trackers reported that **ChatGPT Search's Reddit citations collapsed** — a ~86% drop in citation share (Promptwatch: 3.83% → 0.52%, Jul→Aug) to a ~94% drop in daily volume (Pierview: ~250 → ~16 citations/day in six days) — while **Perplexity's held or rose** (Pierview: Perplexity supplied ~71% of all tracked Reddit citations across Jul–Aug). The **cause is contested**: one tracker attributes the ChatGPT drop to Reddit adding a domain-wide `robots.txt` disallow (~Aug 20 — Reddit issued no official statement on motive), the other to a ChatGPT-side query-fan-out retrieval change it says was "not on Reddit's side." Both trackers are commercial GEO-analytics vendors, so read the numbers as directional — but they independently agree the *engines split*. The durable lesson reinforces §1: **no single third-party platform is a stable citation channel across all engines** — a platform's policy or one engine's retrieval change can zero out a channel overnight, so weight owned properties and diversified brand ubiquity over any one surface, and read Reddit's contribution **per engine**, never blended.

> **Contested:** the ranking→citation link is loosening. Top-10 results supplied ~76% of AI Overview citations in mid-2025 but ~38% (Ahrefs) to as low as 17% (BrightEdge) by early 2026. Sources disagree on the number; all agree the link is weakening. A **peer measurement backs the direction** (stronger evidence than the commercial trackers above): a study of 55,393 AI Overviews across 19 topics (Xu, Iqbal & Montgomery, arXiv, March–April 2026) found **nearly 30% of AI-Overview-cited domains do not appear in the first-page results at all**, and the cited domains were on average *more* credible than the first-page results shown beside them. Discovery is genuinely decoupling from rank — a page Google trusts can be cited without ranking on page one. Don't abandon SEO — but don't assume a #1 ranking guarantees the citation, or that being off page one rules you out.
...
- **Trust is the top E-E-A-T factor.** Accurate, verifiable claims win — and AI engines will happily cite an inaccurate page, which becomes reputational risk. Fact-check harder than you did for classic SEO.
  - _New risk, flagged (2026 measurement):_ the answer often isn't faithful to the pages it cites. Decomposing **98,020 atomic AI-Overview claims**, the same study (Xu, Iqbal & Montgomery, arXiv 2026) found **~11% were unsupported by the pages cited, with omission the dominant failure** — the answer states a fact *no* cited source mentions roughly 2.6× more often than one a cited source contradicts. So your page can be attached as a citation to a claim it never made. Monitoring your AI citations therefore has to check **claim-level fidelity** — is the sentence credited to you one you actually support? — not just whether your URL appeared. Being cited for a claim you don't stand behind is a reputational defect, not a win.
...
12. Seed and engage authentically in the subreddits your buyers read (~6× G2 for B2B SaaS) — but read it **per engine**: ChatGPT Search's Reddit citations collapsed in Aug 2026 while Perplexity's held (§2), so don't treat any one platform as a channel that pays off everywhere.
...
- GEO research — [GEO: Generative Engine Optimization (Aggarwal et al., KDD 2024)](https://arxiv.org/abs/2311.09735) · [Optimizing Visibility in Generative Engines: A Critical Survey of GEO 2023–2026 (Martinez, arXiv, July 2026 — 45 studies; no stable cross-platform causal effect on organic discoverability, causal gains bounded to already-retrieved content)](https://arxiv.org/abs/2607.14035) · [Measuring Google AI Overviews: Activation, Source Quality, Claim Fidelity, and Publisher Impact (Xu, Iqbal & Montgomery, arXiv, May 2026 — 55,393 AI Overviews / 98,020 atomic claims; ~11% of claims unsupported by cited pages, omission-dominant; ~30% of cited domains absent from first-page results)](https://arxiv.org/abs/2605.14021)
...
- Reddit citation divergence (Aug 2026, commercial GEO trackers — cause contested, read as directional) — [explainx.ai / Promptwatch: ChatGPT Reddit citations drop ~86%](https://explainx.ai/blog/reddit-citations-chatgpt-search-drop-august-2026) · [Pierview: Reddit citations fell in ChatGPT while Perplexity doubled down](https://www.pierview.ai/guides/reddit-citations-chatgpt-perplexity-decline-2026)
