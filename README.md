...
**An open-source AI marketing team for B2B SaaS — 85 AI marketing agents for Claude Code, one orchestrator, real playbooks.**

Install a full B2B SaaS marketing org into Claude Code: 85 role-based agent personas, packaged as **19 skills**, coordinated by the **CATALYST** multi-agent orchestrator — with worked ABM, launch & demand-gen workflows and an actively-maintained **AEO/GEO** playbook for the AI-search era.
...
[![Agents](https://img.shields.io/badge/agents-85-blue)](AGENTS_INDEX.md)
...
[Quick start](#-quick-start) · [The 85 agents](#-the-team-85-specialist-agents) · [Skills](#-skills) · [CATALYST](#️-catalyst-orchestrator) · [Loops](#-marketing-loops) · [AEO/GEO](#-built-for-ai-search-aeogeo) · [Contributing](#-contributing)
...
## 📋 The team (85 specialist agents)

Every agent is a named role with its own remit, critical rules, and deliverables — click any one to read it.

| Discipline | Agents |
|-----------|--------|
| **Content Marketing** (9) | [Content Blog Strategist](content/content-blog-strategist.md) · [Content Case Study Producer](content/content-case-study-producer.md) · [Content Copywriter](content/content-copywriter.md) · [Content Newsletter Curator](content/content-newsletter-curator.md) · [Content Operations Manager](content/content-operations-manager.md) · [Content Thought Leadership Ghostwriter](content/content-thought-leadership-ghostwriter.md) · [Content Video Script Writer](content/content-video-script-writer.md) · [Content Whitepaper Architect](content/content-whitepaper-architect.md) · [Customer Education Strategist](content/content-customer-education-strategist.md) |
...
_These 17 disciplines hold all 85 specialist agents. On top sits the **[CATALYST orchestrator](#️-catalyst-orchestrator)**, which coordinates them._
...
|-------|--------|-------------|
| **CATALYST Orchestrator** | all 85 | "GTM launch", "campaign plan", "marketing strategy" |
| **SaaS Marketing Suite** (router) | — | "help with marketing", "what can you do" |
| **Content Marketing** | 9 | "blog", "case study", "whitepaper", "newsletter", "content brief", "editorial calendar", "content ops", "who reviews this", "our content pipeline is stuck", "content audit", "style guide", "AI content policy", "customer academy", "online course", "certification program", "our tutorial shows the old UI", "should the academy be gated" |
| **SEO Growth** | 7 | "SEO audit", "keyword research", "AEO", "link building", "programmatic SEO", "hreflang", "our translated pages get no traffic", "do we need a Google Business Profile in Germany", "G2 / Capterra listing", "get into a 'best software' roundup", "directory submissions" |
| **Paid Media Ops** | 7 | "Google Ads", "LinkedIn Ads", "ROAS", "attribution", "newsletter sponsorship", "content syndication", "budget pacing", "we underspent our budget", "are our campaigns competing with each other", "audience overlap", "self-competition", "suppression list", "ad frequency across channels", "ads in AI Overviews", "should we advertise on ChatGPT", "ChatGPT Ads", "AI Mode ads", "can we buy our way into the AI answer", "our ad landing page fails review" |
| **Social Media Ops** | 7 | "LinkedIn strategy", "LinkedIn newsletter", "should we start a LinkedIn newsletter", "LinkedIn Events", "LinkedIn Live", "event registration form", "YouTube", "community", "podcast", "show notes", "podcast guesting", "how do I know if this podcast has real listeners", "the host says they get 50k downloads", "is this podcast worth going on", "IAB podcast measurement certification", "Listen Score", "vet this influencer", "is this creator's engagement real", "sponsored post disclosure", "who has admin on our social accounts", "our social media manager left", "social post approval workflow" |
| **Email Marketing Ops** | 5 | "email sequence", "nurture", "deliverability", "SPF/DKIM/DMARC", "our emails go to spam", "cold email sending domains", "domain warmup", "set up sending infrastructure", "frequency cap", "customers get too many emails from different teams" |
| **Design Ops** | 5 | "landing page", "brand identity", "ad creative" |
| **Sales Enablement** | 8 | "website chatbot", "AI SDR", "what should our chat agent be allowed to say", "our chatbot quoted a price", "do we have to disclose it's AI", "chat handoff to sales", "outbound", "battle card", "proposal", "MEDDPICC", "demo plan", "proof of concept", "security questionnaire", "AI security questionnaire", "the buyer is asking if we train on their data", "which model do we use", "AI-CAIQ", "ISO 42001", "are we a provider or a deployer", "mutual action plan", "close plan", "the deal is stalled" |
| **Product Marketing Ops** | 10 | "positioning", "product launch", "beta / early access program", "when can we call it GA", "competitive intel", "win/loss interviews", "why we lose deals", "customer referral program", "refer a friend reward", "displace an incumbent", "win deals from a competitor", "switching costs", "their contract renews when?", "pricing", "packaging", "agent readiness", "expand into Europe", "market entry", "which country next", "localization", "brand awareness", "brand vs performance", "how do we measure brand", "share of search", "category entry points", "demand creation", "sell to government", "public sector marketing", "FedRAMP marketing claims", "gift rules for government officials", "how can agencies buy from us" |
| **Marketing Analytics** | 9 | "CRO", "A/B testing", "sample size", "not enough traffic to test", "dashboards", "attribution", "tracking plan", "GA4 audit", "martech stack audit", "too many tools", "build vs buy", "ESP/CRM migration", "switching cost", "customer interviews", "survey design", "how many people should I interview", "voice of customer", "jobs-to-be-done", "is this finding real", "data enrichment", "which enrichment provider", "waterfall enrichment", "bad list data", "email verification", "data decay", "where did this list come from", "demand planning", "how many leads do we need to hit the target", "build the marketing plan", "top-down vs bottom-up plan", "plan of record", "our leads can't close this quarter", "sales-cycle lag", "scenario band", "stretch target", "reforecast triggers", "we missed plan and nobody knows why", "AI policy for the marketing team", "which AI tools are we allowed to use", "can I paste customer data into ChatGPT", "shadow AI", "our AI vendor changed the model", "turn off Google Ads auto-generated assets", "EU AI Act AI literacy" |
| **Marketing Project Mgmt** | 4 | "sprint planning", "resource allocation", "QBR" |
| **Client Operations** | 4 | "client reporting", "QA", "compliance", "budget", "someone asked us to delete their data", "right to erasure", "GDPR deletion request", "do we delete or suppress", "they unsubscribed and we emailed them again", "do we have to disclose AI voice", "AI presenter disclosure", "EU AI Act", "C2PA" |
| **Growth Ops** | 3 | "PLG", "activation", "PQL", "free trial", "expansion", "churn", "NRR", "interactive demo", "product tour", "self-guided demo", "should our demo be gated?" |
...
| **Partnerships Ops** | 2 | "co-marketing", "channel", "integration launch", "AWS Marketplace", "channel conflict", "deal registration", "should we build a partner program", "partner economics" |
