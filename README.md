...
**An open-source AI marketing team for B2B SaaS — 78 specialist agents, one orchestrator, real playbooks.**

Install a full B2B SaaS marketing org into Claude Code: 78 role-based agent personas, packaged as **19 skills**, coordinated by the **CATALYST** multi-agent orchestrator — with worked ABM, launch & demand-gen workflows and an actively-maintained **AEO/GEO** playbook for the AI-search era.
...
[![Agents](https://img.shields.io/badge/agents-78-blue)](AGENTS_INDEX.md)
...
[Quick start](#-quick-start) · [The 78 agents](#-the-team-78-specialist-agents) · [Skills](#-skills) · [CATALYST](#️-catalyst-orchestrator) · [Loops](#-marketing-loops) · [AEO/GEO](#-built-for-ai-search-aeogeo) · [Contributing](#-contributing)
...
_These 17 disciplines hold all 78 specialist agents. On top sits the **[CATALYST orchestrator](#️-catalyst-orchestrator)**, which coordinates them._
...
|-------|--------|-------------|
| **CATALYST Orchestrator** | all 78 | "GTM launch", "campaign plan", "marketing strategy" |
...
| **Marketing Analytics** | 7 | "CRO", "A/B testing", "sample size", "not enough traffic to test", "dashboards", "attribution", "tracking plan", "GA4 audit", "martech stack audit", "too many tools", "build vs buy", "ESP/CRM migration", "switching cost", "customer interviews", "survey design", "how many people should I interview", "voice of customer", "jobs-to-be-done", "is this finding real", "data enrichment", "which enrichment provider", "waterfall enrichment", "bad list data", "email verification", "data decay", "where did this list come from" |
