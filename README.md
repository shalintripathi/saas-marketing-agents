...
[![Agents](https://img.shields.io/badge/agents-79-blue)](AGENTS_INDEX.md)
...
[Quick start](#-quick-start) · [The 79 agents](#-the-team-79-specialist-agents) · [Skills](#-skills) · [CATALYST](#️-catalyst-orchestrator) · [Loops](#-marketing-loops) · [AEO/GEO](#-built-for-ai-search-aeogeo) · [Contributing](#-contributing)
...
This is the opposite. It's a marketing team shaped like a real **B2B SaaS marketing org** — 79 specialist agents with defined roles and hand-offs, plus an orchestrator that turns one brief into assigned sub-tasks. You brief the team; it routes the work.
...
_These 17 disciplines hold all 79 specialist agents. On top sits the **[CATALYST orchestrator](#️-catalyst-orchestrator)**, which coordinates them._
...
|-------|--------|-------------|
| **CATALYST Orchestrator** | all 79 | "GTM launch", "campaign plan", "marketing strategy" |
