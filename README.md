...
**An open-source AI marketing team for B2B SaaS — 80 AI marketing agents for Claude Code, one orchestrator, real playbooks.**

Install a full B2B SaaS marketing org into Claude Code: 80 role-based agent personas, packaged as **19 skills**, coordinated by the **CATALYST** multi-agent orchestrator — with worked ABM, launch & demand-gen workflows and an actively-maintained **AEO/GEO** playbook for the AI-search era.
...
[![Agents](https://img.shields.io/badge/agents-80-blue)](AGENTS_INDEX.md)
...
[Quick start](#-quick-start) · [The 80 agents](#-the-team-80-specialist-agents) · [Skills](#-skills) · [CATALYST](#️-catalyst-orchestrator) · [Loops](#-marketing-loops) · [AEO/GEO](#-built-for-ai-search-aeogeo) · [Contributing](#-contributing)
...
_These 17 disciplines hold all 80 specialist agents. On top sits the **[CATALYST orchestrator](#️-catalyst-orchestrator)**, which coordinates them._
...
|-------|--------|-------------|
| **CATALYST Orchestrator** | all 80 | "GTM launch", "campaign plan", "marketing strategy" |
