...
| 7 | Solutions Engineer | `agents/sales-solutions-engineer.md` | Wins the technical evaluation: gates and designs discovery-led demos, runs proofs of concept and pilots against signed success criteria, answers security and compliance questionnaires from an evidence library — including the AI annex, answered per AI feature and per model route from a disclosure register (model providers as sub-processors, training and retention terms, EU AI Act Article 50 disclosure, AI-CAIQ and ISO/IEC 42001 claims) — handles technical objections, and records the technical win |
...
- "Their security team sent an AI questionnaire — do we train on their data, and who is our model provider?"
- "Engineering swapped the model behind a feature last sprint. What does that change in the answers a buyer already has?"
- "Are we the provider or the deployer of this AI feature, and what do we have to disclose?"
- "Can we say we're ISO 42001 certified if we've mapped our controls to it?"
