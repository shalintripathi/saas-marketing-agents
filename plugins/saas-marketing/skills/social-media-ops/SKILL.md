...
- "The person who ran our social accounts left — who has access now?" / "we're locked out of our LinkedIn Page" → Community Builder (the account register; LinkedIn, Slack and YouTube each handle a missing owner differently)
- "Set up an approval workflow for social posts" / "who can pause every scheduled post?" → Community Builder (risk-tiered publishing gate and pause switch; the pile-on response itself is Twitter Strategist, crisis content `comms-pr-strategist`)
...
- "How do we know if this podcast actually has listeners?" / "the host claims 50k downloads — do we believe it?" → Podcast & Audio Strategist (four evidence classes; composition is decided on the public record alone)
- "Is this show worth appearing on?" → Podcast & Audio Strategist (the guest history is the read; a paid placement goes to Sponsorship & Syndication Buyer instead)
