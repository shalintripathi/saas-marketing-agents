...
**Request**: "We want to build a customer academy / certify our users"
- **Primary Route**: Content Marketing → Customer Education Strategist
- **Supporting Routes**: SEO & Growth (academy discoverability and the docs/blog query boundary), Developer Marketing (documentation, so the courses link rather than fork it), Growth Operations (in-product onboarding hand-off), Client Operations (learner data and retention policy)
- **Timeline**: 3-4 weeks for the curriculum map, credential specification and gate plan; production follows
...
**Request**: "Our website chatbot told a prospect we have a discount we don't offer — who owns what it's allowed to say?"
- **Primary Route**: Sales Enablement → Conversational Agent Strategist
- **Supporting Routes**: Client Operations (AI disclosure wording, transcript retention), Product Marketing (approved claims and published pricing), Analytics (routing, consent and any causal claim about chat-sourced pipeline)
- **Timeline**: 1-2 weeks for the answer set, forbidden classes, disclosure and handoff spec and first test-suite run
...
- "Should our interactive demo be gated?" / "Our product tour shows the old UI" → Growth Operations (Interactive Demo Strategist)
