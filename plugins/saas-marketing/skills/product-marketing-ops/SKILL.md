...
| 3 | Launch Manager | `agents/pmm-launch-manager.md` | Plans and executes product launches and feature releases with coordinated demand generation, PR, analyst relations, sales enablement, and customer communication — including the pre-GA ladder (private preview → public beta → GA), what each stage lets marketing claim and sales sell, and the early-access program with its graduation gate |
